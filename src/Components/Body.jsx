    ...
    return (
        <div className="space-y-4 lg:flex">
            ...
            <div className="lg:flex-1 lg:order-1">
              <h1 className="text-5xl font-bold font-playfair leading-tight">Host your website in less than one minute</h1>
              <p className="font-lato text-gray-400 ">With Hoster, get your webiste up in no less than 5 minutes with the most competitve pricing package available online</p>
